...
class _SignupState extends State<Signup> {
  ...
  final TextEditingController _controllerUsertype = TextEditingController();
                    ...
                    onPressed: () async {
                      ...
                      if (validate) {
                        var data = {
                          ...
                          // 'usertype': _controllerUsertype.text.toUpperCase(),
                          'usertype': _selectedUserType!.toUpperCase(),
                        ...
                        if (result["status"]) {
                          ...
                          if (result["body"]["errors"]["email"] != null) {
                            ShowMToast(context).errorToast(
                                message:
                                    "${result["body"]["errors"]["email"]} ☹️",
                                alignment: Alignment.bottomCenter);
                          } else if (result["body"]["errors"]["phone"] !=
                              null) {
                            ShowMToast(context).errorToast(
                                message:
